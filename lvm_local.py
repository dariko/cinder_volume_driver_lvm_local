...
class LVMLocalVolumeDriver(driver.VolumeDriver):
    ...
    def __init__(self, vg_obj=None, *args, **kwargs):
        ...
        super(LVMLocalVolumeDriver, self).__init__(*args, **kwargs)
    ...
    def _update_volume_stats(self):
        ...
        location_info = \
            ('LVMLocalVolumeDriver:%(hostname)s:%(vg)s'
    ...
    def migrate_volume(self, ctxt, volume, host, thin=False, mirror_count=0):
        ...
        try:
            ...
            return false_ret
        if (dest_type != 'LVMLocalVolumeDriver' or dest_hostname != self.hostname):
            return false_ret
    ...
    def create_export(self, context, volume, connector, vg=None):
        ...
        return {
            'provider_location': "/dev/%s/%s" % (vg, volume['name'])
        }
